...
lines((length(time)+1):(length(time)+length(NEEnew)),NEEnew,col="red")
...
lines((length(time)+1):(length(time)+length(LEnew)),LEnew,col="red")
#points(Mtime, LAIr)                                                   ## observations
#for(i in 1:length(LAIr)){                                             ## observation uncertainty
#  if(!is.na(QC[i])){
#    lines(rep(Mtime[i], 2), LAIr[i]+c(-1, 1) * LAIr.sd[i])            ## data is +/- 1 SD; NOT 95%
...
lines((length(time)+1):(length(time)+length(VSWCnew)),VSWCnew,col="red")
#points(Mtime, LAIr)                                                   ## observations
#for(i in 1:length(LAIr)){                                             ## observation uncertainty
#  if(!is.na(QC[i])){
#    lines(rep(Mtime[i], 2), LAIr[i]+c(-1, 1) * LAIr.sd[i])            ## data is +/- 1 SD; NOT 95%
