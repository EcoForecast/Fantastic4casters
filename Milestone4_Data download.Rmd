...
for(i in 1:4){
  foo0_subset_by_site = subset(foo, ensemble == 0 & siteID == sites[i])
}
plot(foo0_subset_by_site$time, foo0_subset_by_site[1]$air_temperature, type = 'l')
for( i in 2:4){
  lines(foo0_subset_by_site$time, foo0_subset_by_site[i]$air_temperature, col = i)
}
