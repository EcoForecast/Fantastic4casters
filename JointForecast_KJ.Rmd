...
data_joint<-list(NEE_obs=data_03$NEE_obs,LE_obs=data_03$LE_obs,VSWC_obs=data_03$VSWC_obs, n=length(time_KONZ),
            ...
            a_nee_obs=0.1, r_nee_obs=0.1, a_nee_add=0.1, r_nee_add=0.1,
            a_le_obs=0.1, r_le_obs=0.1, a_le_add=0.1, r_le_add=0.1,
...
jags.out_BART_test <- coda.samples (model = j.model_joint,
...
newFilename <- sprintf("%s.Rdata","LE_BART_joint")
newFilename <- paste(dataPath, newFilename, sep="", collapse = NULL)
save(jags.out_BART_test, file = newFilename)
