...
```{r}
## BART
burnin = 1400                                ## determine convergence
jags.burn <- window(jags.out_vswc_BART,start=burnin)  ## remove burn-in
plot(jags.burn)                             ## check diagnostics post burn-in

GBR <- gelman.diag(jags.out_vswc_BART)
GBR
...
##KONZ
burnin = 1400                                ## determine convergence
jags.burn <- window(jags.out_vswc_KONZ,start=burnin)  ## remove burn-in
plot(jags.burn)                             ## check diagnostics post burn-in

GBR <- gelman.diag(jags.out_vswc_KONZ)
GBR
...
##OSBS
burnin = 1400                                ## determine convergence
jags.burn <- window(jags.out_vswc_OSBS,start=burnin)  ## remove burn-in
plot(jags.burn)                             ## check diagnostics post burn-in

GBR <- gelman.diag(jags.out_vswc_OSBS)
GBR
...
##SRER
burnin = 1400                                ## determine convergence
jags.burn <- window(jags.out_vswc_SRER,start=burnin)  ## remove burn-in
plot(jags.burn)                             ## check diagnostics post burn-in

GBR <- gelman.diag(jags.out_vswc_SRER)
GBR
